      ...
      try {
        ...
        try {
          ...
          toast({
            title: "Warning",
            description:
              "Failed to fetch ElevenLabs voices. Other voices will still be available.",
            variant: "default",
          });
        }
        ...
        try {
          ...
          formattedDeepgramVoices = deepgramVoices.map((voice) => ({
            ...
            provider: "Deepgram",
            traits: [voice.description || ""].filter(Boolean),
            preview_url: voice.preview_url,
          ...
          toast({
            title: "Warning",
            description:
              "Failed to fetch Deepgram voices. Other voices will still be available.",
            variant: "default",
          });
        }
        ...
        try {
          ...
          formattedPlayhtVoices = playhtVoices.map((voice) => ({
            ...
            language: voice.language,
            provider: "Playht",
            traits: [voice.voiceEngine, voice.description || ""].filter(
              Boolean
            ),
            preview_url: voice.preview_url,
            playht_id: voice.id,
          ...
          toast({
            title: "Warning",
            description:
              "Failed to fetch PlayHT voices. Other voices will still be available.",
            variant: "default",
          });
        }
        ...
        try {
          ...
          toast({
            title: "Warning",
            description:
              "Failed to fetch Cartesia voices. Other voices will still be available.",
            variant: "default",
          });
        }
