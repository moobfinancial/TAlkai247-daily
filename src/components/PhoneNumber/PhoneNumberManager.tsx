...
export function PhoneNumberManager() {
  ...
  const handleNumberPurchase = (number: { number: { number: string } }) => {
    ...
    toast({
      ...
      description: `Successfully acquired ${number.number}`,
    });
  };
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              <CardTitle className="text-2xl text-white">
                Welcome to Talkai247
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                <p className="text-gray-300">
                  To begin using our AI-powered calling features, you'll need to
                  acquire a phone number. Click the button below to start the
                  process.
                </p>
                <div className="flex items-center space-x-4">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>
                        Get started by acquiring your first phone number and
        ...
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-400">
                Manage your AI-powered phone numbers and calls
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-1">
              <PhoneList
                ...
                onDelete={(number) => {
                  set(
                    "phoneNumbers",
                    state.phoneNumbers.filter((n) => n !== number)
                  );
                  if (state.selectedNumber === number) {
                    set(
                      "selectedNumber",
                      state.phoneNumbers.find((n) => n !== number) || ""
                    );
                  }
                }}
              />
            ...
            <div className="md:col-span-2">
              <CallControls
                isCallActive={state.activeCalls.length > 0}
                onEndCall={() => {
                  set("activeCalls", []);
                }}
                onStartCall={() => {}}
                ...
                onAddPurchasedNumber={() =>
                  set("showAddPurchasedNumberModal", true)
                }
              />
            </div>
          </div>
