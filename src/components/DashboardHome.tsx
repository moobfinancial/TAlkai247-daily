    ...
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-400">
          Here's an overview of your AI communication metrics
        </p>
      </div>

      <div className="grid grid-cols-4 gap-6 mb-8">
        <StatCard title="Total Minutes" value="0.00" bgColor="bg-[#3b82f6]" />
        <StatCard title="Number of Calls" value="0.00" bgColor="bg-[#eab308]" />
        <StatCard title="Total Spend" value="$0.00" bgColor="bg-[#22c55e]" />
        <StatCard
